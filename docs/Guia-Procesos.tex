...
\date{Última actualización: 15 de agosto de 2021}
...
You can label chapter and section titles using \texttt{\{\#label\}} after them, e.g., we can reference Chapter \ref{intro}. If you do not manually label them, there will be automatic labels anyway, e.g., Chapter \ref{methods}. R is free software and comes with ABSOLUTELY NO WARRANTY.You are welcome to redistribute it under certain conditions.
...
{\centering \includegraphics[width=0.8\linewidth]{Guia-Procesos_files/figure-latex/nice-fig-1} 
